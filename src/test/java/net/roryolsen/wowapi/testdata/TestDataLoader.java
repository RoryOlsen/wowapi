package net.roryolsen.wowapi.testdata;
...
public class TestDataLoader {
	...
	private static final String CHARACTERS_FILE_LOCATION = "net/roryolsen/wowapi/characters.txt";
	private static final String GUILDS_FILE_LOCATION = "net/roryolsen/wowapi/guilds.txt";
