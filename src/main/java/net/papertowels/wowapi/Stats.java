...
public class Stats {
	...
	private double rangedDamageMax;
	private double rangedDamageMin;
	...
	public double getRangedDamageMax() {
		return rangedDamageMax;
	}
	public void setRangedDamageMax(double rangedDamageMax) {
		this.rangedDamageMax = rangedDamageMax;
	}
	public double getRangedDamageMin() {
		return rangedDamageMin;
	}
	public void setRangedDamageMin(double rangedDamageMin) {
